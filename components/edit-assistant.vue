...
<template>
  <div class="p-5">
    <h1 class="text-2xl">{{id ? 'Edit' : 'Create'}} Assistant</h1>
    <UDivider class="my-2"/>

    <UForm :schema="schema" :state="state" class="space-y-4" @submit="go" @error="onError" ref="form">
      ...
      <UFormGroup label="Description">
        <template #hint>
          <UTooltip text="Shown to the user of the assistant"><UIcon name="i-heroicons-light-bulb"/></UTooltip>
        </template>
      ...
      <UFormGroup required label="Instructions">
        <template #hint>
          <UTooltip text="How the model should reply to messages"><UIcon name="i-heroicons-light-bulb"/></UTooltip>
        </template>
