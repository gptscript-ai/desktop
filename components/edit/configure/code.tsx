...
const Code = ({
  ...
  const handleLanguageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (
      codeLines &&
      codeLines[0] &&
      !codeLines[0].startsWith('#!/usr/bin/env')
    ) {
        ...
        <Tab title="Code">
          <div className="border-2 dark:border-zinc-700 rounded-xl">
            <div className="flex justify-between items-center pr-2">
              <div className="flex">
                <select
                  className="pl-2 dark:bg-black text-tiny capitalize"
            ...
            <Modal
              ...
              classNames={{
                base: 'w-[95%] max-w-none h-[95%] max-h-none border-2 dark:border-zinc-700',
              ...
              <ModalContent>
                <ModalHeader>
                  <h1 className="">
                    {`You're writing in`}
                    <select
                      className="text-primary dark:bg-zinc-900 capitalize"
                      value={language.toString()}
                      onChange={(e) => {
                        setLanguage(e.target.value as Language);
                      }}
