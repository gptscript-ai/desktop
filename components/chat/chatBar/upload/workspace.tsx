      ...
      >
        <ModalContent>
          ...
          <ModalBody className="max-h-[900px] overflow-y-scroll">
            <p>
              Changing the workspace for this script requires it to restart.
            </p>
          </ModalBody>
          <ModalFooter className="flex justify-between">
            <Button color="danger" className="w-1/2" onPress={handleConfirm}>
              Confirm and restart
            </Button>
            <Button color="primary" className="w-1/2" onPress={handleClose}>
              Cancel
            </Button>
          </ModalFooter>
        </ModalContent>
